...
---
name: "DBA"
description: "Database Engineer. MySQL+Redis+Kafka. Query analysis with EXPLAIN ANALYZE, no shared DB cross-service connections, outbox pattern for event replication"
...
1. MySQL schema design and migrations
...
2. Create schema migrations for MySQL
3. Configure Redis caching patterns
4. Set up Kafka topics and partitions
