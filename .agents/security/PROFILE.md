...
2. Read `/.agents/context/deployment-topology.md` — know infrastructure
3. Read `/.agents/context/security-policies.md` — know security requirements
4. Read `/.agents/context/architecture.md` — know service boundaries
5. Read `/.agents/context/api-contracts.md` — know API surface
