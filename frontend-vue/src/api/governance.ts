...
export const auditLogApi = {
  async getLogs(params?: Record<string, unknown>): Promise<AuditLogEntry[]> {
    const res = await api.get<ApiResponse<AuditLogEntry[]>>('/audit/logs', params as Record<string, string | number>)
    return res.data || []
  }
}
