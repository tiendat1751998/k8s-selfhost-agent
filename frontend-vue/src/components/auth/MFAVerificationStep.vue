<template>
  ...
  >
    <div class="step-header">
      <div class="step-icon"><BaseIcon name="lock" size="md" /></div>
    ...
    <div class="auth-switch-links">
      <button type="button" class="text-link-btn" @click="$emit('switchToRecovery')">
        <BaseIcon name="key" size="xs" /> Use Recovery Code Instead
      </button>
  ...
  >
    <div class="step-header">
      <div class="step-icon"><BaseIcon name="key" size="md" /></div>
    ...
    <div class="auth-switch-links">
      <button type="button" class="text-link-btn" @click="$emit('switchToTotp')">
        <BaseIcon name="lock" size="xs" /> Use Authenticator App
      </button>
      <button type="button" class="text-link-btn back-btn" @click="$emit('back')">
        ← Back to Sign In
      </button>
