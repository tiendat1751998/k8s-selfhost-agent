    ...
    <form class="settings-form" @submit.prevent="emit('save', 'integrations')">
      <div class="integrations-grid">
        ...
        <div class="integration-item glass-panel">
          <div class="integration-header">
            <div class="integration-title-group">
              <div class="integration-icon"><BaseIcon name="git-branch" size="md" /></div>
              <div>
            ...
            <div class="integration-status">
              ...
              <span v-else-if="integrationTests.argocd_url?.result?.reachable" class="badge badge-emerald">
                <BaseIcon name="check-circle" size="xs" /> HTTP {{ integrationTests.argocd_url.result.status_code }} ({{ integrationTests.argocd_url.result.latency_ms }}ms)
              </span>
              <span v-else-if="integrationTests.argocd_url?.result && !integrationTests.argocd_url?.result?.reachable" class="badge badge-rose">
                <BaseIcon name="x-circle" size="xs" /> Unreachable ({{ integrationTests.argocd_url.result.latency_ms }}ms)
              </span>
              <span v-else-if="integrationTests.argocd_url?.error" class="badge badge-rose">
                <BaseIcon name="x-circle" size="xs" /> {{ integrationTests.argocd_url.error }}
              </span>
        ...
        <div class="integration-item glass-panel">
          <div class="integration-header">
            <div class="integration-title-group">
              <div class="integration-icon"><BaseIcon name="shield" size="md" /></div>
              <div>
            ...
            <div class="integration-status">
              ...
              <span v-else-if="integrationTests.trivy_url?.result?.reachable" class="badge badge-emerald">
                <BaseIcon name="check-circle" size="xs" /> HTTP {{ integrationTests.trivy_url.result.status_code }} ({{ integrationTests.trivy_url.result.latency_ms }}ms)
              </span>
              <span v-else-if="integrationTests.trivy_url?.result && !integrationTests.trivy_url?.result?.reachable" class="badge badge-rose">
                <BaseIcon name="x-circle" size="xs" /> Unreachable ({{ integrationTests.trivy_url.result.latency_ms }}ms)
              </span>
              <span v-else-if="integrationTests.trivy_url?.error" class="badge badge-rose">
                <BaseIcon name="x-circle" size="xs" /> {{ integrationTests.trivy_url.error }}
              </span>
        ...
        <div class="integration-item glass-panel">
          <div class="integration-header">
            <div class="integration-title-group">
              <div class="integration-icon"><BaseIcon name="lock" size="md" /></div>
              <div>
            ...
            <div class="integration-status">
              ...
              <span v-else-if="integrationTests.vault_url?.result?.reachable" class="badge badge-emerald">
                <BaseIcon name="check-circle" size="xs" /> HTTP {{ integrationTests.vault_url.result.status_code }} ({{ integrationTests.vault_url.result.latency_ms }}ms)
              </span>
              <span v-else-if="integrationTests.vault_url?.result && !integrationTests.vault_url?.result?.reachable" class="badge badge-rose">
                <BaseIcon name="x-circle" size="xs" /> Unreachable ({{ integrationTests.vault_url.result.latency_ms }}ms)
              </span>
              <span v-else-if="integrationTests.vault_url?.error" class="badge badge-rose">
                <BaseIcon name="x-circle" size="xs" /> {{ integrationTests.vault_url.error }}
              </span>
        ...
        <div class="integration-item glass-panel">
          <div class="integration-header">
            <div class="integration-title-group">
              <div class="integration-icon"><BaseIcon name="activity" size="md" /></div>
              <div>
            ...
            <div class="integration-status">
              ...
              <span v-else-if="integrationTests.grafana_url?.result?.reachable" class="badge badge-emerald">
                <BaseIcon name="check-circle" size="xs" /> HTTP {{ integrationTests.grafana_url.result.status_code }} ({{ integrationTests.grafana_url.result.latency_ms }}ms)
              </span>
              <span v-else-if="integrationTests.grafana_url?.result && !integrationTests.grafana_url?.result?.reachable" class="badge badge-rose">
                <BaseIcon name="x-circle" size="xs" /> Unreachable ({{ integrationTests.grafana_url.result.latency_ms }}ms)
              </span>
              <span v-else-if="integrationTests.grafana_url?.error" class="badge badge-rose">
                <BaseIcon name="x-circle" size="xs" /> {{ integrationTests.grafana_url.error }}
              </span>
      ...
      <div class="form-actions">
        ...
        <button type="submit" class="btn btn-primary" :disabled="saving">
          ...
          <BaseIcon name="hard-drive" size="xs" /> <span>{{ saving ? 'Saving Changes...' : 'Save Integration Settings' }}</span>
        </button>
      </div>
    </form>
  </div>
