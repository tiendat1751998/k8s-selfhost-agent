...
def setup_telemetry() -> str | None:
    ...
    # Set up OpenTelemetry exporters for Cloud Trace and Cloud Logging only if using Vertex AI
    if os.getenv("GOOGLE_GENAI_USE_VERTEXAI") == "True":
        try:
            ...
            logging.warning("Failed to initialize telemetry GCP exporters: %s", ex)
